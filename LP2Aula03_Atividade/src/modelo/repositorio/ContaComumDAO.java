...
/*	// recuperarContaComumPorNumero: este metodo está dando erro no método efetivarMovimento da classe Movimento
	...
	// Ou 
	public ContaComum obterContaComumPorNumeroConta(long numero)
	{
	...
	// editarContaComum
		...
		public int removerContaComum(long numero)
		{
			...
			try {
				...
				System.out.println("Erro ao tentar remover os dados da conta comum! " + e.getMessage());
			}
