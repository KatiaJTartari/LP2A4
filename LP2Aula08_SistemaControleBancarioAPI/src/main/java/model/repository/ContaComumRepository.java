...
{
	public static long criarContaComum(ContaComum contaComum)
	{
		...
		return contaComum.getNumeroConta();
	}
	...
	public static boolean excluirContaComumPorNumeroConta(long numeroConta)
	{
		boolean resultado = true;
		
		try
		{
			ContaComum contaComum = recuperarContaComumPorNumeroConta(numeroConta);
			resultado = excluirContaComum(contaComum);
		}
		catch (Exception e)
		{
			System.out.println("Erro ao tentar remover a conta comum! " + e.getMessage());
